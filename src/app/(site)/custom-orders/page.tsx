...
export default async function CustomOrdersPage() {
	...
	const customOrderStrings = contactContent
		? {
				...
				descriptionLabel:
					contactContent.customOrderFormDescriptionLabel ?? "Hvad ønsker du?",
				descriptionPlaceholder:
					contactContent.customOrderFormDescriptionPlaceholder ??
					"Størrelse, farve, tekstur, brug — jo mere, jo bedre.",
				quantityLabel: contactContent.customOrderFormQuantityLabel ?? "Antal",
				quantityPlaceholder:
					contactContent.customOrderFormQuantityPlaceholder ?? "F.eks. 2",
				budgetLabel: contactContent.customOrderFormBudgetLabel ?? "Budgetramme",
				budgetPlaceholder:
					contactContent.customOrderFormBudgetPlaceholder ??
					"F.eks. 500–1000 kr.",
				timelineLabel:
					contactContent.customOrderFormTimelineLabel ?? "Ønsket tidslinje",
				timelinePlaceholder:
					contactContent.customOrderFormTimelinePlaceholder ??
					"F.eks. inden jul",
				submit: contactContent.customOrderFormSubmit ?? "Send bestilling",
				pending: contactContent.customOrderFormPending ?? "Sender...",
				successHeading:
					contactContent.customOrderFormSuccessHeading ??
					"Tak for din bestilling",
				successBody:
					contactContent.customOrderFormSuccessBody ??
	...
	return (
		<main className="py-24 pb-16">
			<div className="mx-auto max-w-screen-xl px-6 sm:px-8 lg:px-16">
				<h1 className="mb-4 font-normal font-serif text-3xl text-ink tracking-tight sm:text-4xl lg:text-5xl">
